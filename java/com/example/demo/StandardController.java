...
//    	    }
    ...
    public String addStandard( @RequestParam("standardNumber") String standardNumber) {
    	System.out.println("Received Standard: " + standardNumber);
//        System.out.println("Test Item: " + standard.getStandardNumber());
//        System.out.println("Method: " + standard.getTestItem().getMethod());
        // 将新数据追加到 XML 文件中
