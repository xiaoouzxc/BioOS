...
public class Simple {
	...
	public Simple(String number, String name, String testItem, String testMethod, String ifF, String result,int done) {
		this.number = number;
		this.name = name;
		this.testItem = testItem;
		this.testMethod = testMethod;
	...
	public Simple(String number, String name, String testItem, String testMethod, String tip, String ifF,
			String result) {
		this.number = number;
		this.name = name;
		this.testItem = testItem;
