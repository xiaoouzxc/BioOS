			...
			try {
				...
				while (simpleInfo.next()) {
					if (simpleInfo.getString("复测") == null) {
						...
						BFsimpleList.add(new Simple(simpleInfo.getString("样品短号"), simpleInfo.getString("样品名称"),
						...
						if (!simpleInfo.getString("检测项目").contains("沙")) {
							FsimpleList.add(new Simple(simpleInfo.getString("样品短号"), simpleInfo.getString("样品名称"),
									simpleInfo.getString("检测项目"), simpleInfo.getString("检测方法"),
									simpleInfo.getString("复测"), simpleInfo.getString("结果"), simpleInfo.getInt("done")));
						}
					}
