...
//		    }
	...
	@RequestMapping("/b")
	public void ajax2(String simpleNum, String simpleName, String table_name, HttpServletResponse response,
			Model model) {
		AddFtoSimple ats = new AddFtoSimple();
		ats.getNumber(simpleNum, simpleName, table_name, model);
	}

	@RequestMapping("/b1")
	public void addSelomenFtoTodayTable(String simpleNum, String table_name, HttpServletResponse response,
			Model model) {
		AddFtoSimple ats = new AddFtoSimple();
		ats.setSelomenToFlabel(simpleNum, table_name, model);
	}
	...
	@RequestMapping("/d")
	public void insertReacordingData(String simpleNum, String simpleName, String data, String table_name,
			HttpServletResponse response, Model model) {
		ReacordingController rc = new ReacordingController();
		rc.setDataMethord(simpleNum, simpleName, data, table_name);
	}
